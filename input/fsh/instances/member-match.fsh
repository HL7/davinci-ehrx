...
* parameter[0]
  ...
  * referencedFrom[+]
    ...
    * sourceId = "beneficiary"
* parameter[+]
  * insert parameter(#Consent, #in, 0, "1", #Resource, "Consent held by the system seeking the match that grants permission to access the patient information information on the system for whom a patient is sought.")
* parameter[+]
