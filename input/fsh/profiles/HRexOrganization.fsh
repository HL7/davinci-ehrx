...
* ^extension[$compliesWithProfile][0].valueCanonical = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-organization|6.1.0"
* ^extension[$compliesWithProfile][1].valueCanonical = "http://hl7.org/fhir/us/core/StructureDefinition/us-core-organization|3.1.1"
* ^status = #active
* . ^mustSupport = false
  * ^isModifier = false
* identifier 1..
