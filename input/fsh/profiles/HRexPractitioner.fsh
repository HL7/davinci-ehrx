...
* qualification MS
  ...
  * code 1.. MS
    ...
    * text 1.. MS
      * ^requirements = "There is no consistency for how qualifications are currently captured, so can't agree on a standardized value set.  But we can at least expose a human-readable string.  In future releases, we might be able to move towards common terminology."